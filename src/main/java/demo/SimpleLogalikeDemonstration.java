...
/**
 * A simple demonstration on how to use Logsmart to create an endless stream of messages and print them to std::out.
 * 
 * @author jepeders
 */
public class SimpleLogalikeDemonstration {
