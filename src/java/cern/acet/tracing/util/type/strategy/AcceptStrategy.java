 ...
 * {@link Object} type.
 */
public enum AcceptStrategy implements TypeStrategy {

    INSTANCE;

    private static final String TYPE_MISMATCH_FORMAT = "Type mismatch when inserting value %s with type %s under "
            + "the key %s with required type %s";
